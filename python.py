...
class Python(Snake):
    def __init__(self):
        super().__init__()  # a keyword called SUPER which inherits everything from parent class (Animal)at the time of initialisation of this class
        self.large = True
        self.two_lungs = True
        self.venom = False
...
print(f'{python_object.__use_tongue_to_smell()}')
